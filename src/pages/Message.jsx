...
const Message = () => {
  ...
  const handleSubmit = async (e) => {
   ...
   return (
     ...
     //   <div className="flex flex-col lg:flex-row gap-8 lg:gap-24 mt-10">
     //      <div
     //         className="h-8 w-8 rounded-full bg-pink-200 flex justify-center items-center cursor-pointer"
     //         onClick={() => navigate(-1)}
     //       >
     ...
     //         <div>
     //           <h1 className="font-medium">Living Status</h1>
     //           <p className="text-gray-500">{singleRelationship?.livingStatus}</p>
     //         </div>
     //       </div>
     ...
     //       <div className="max-w-md mx-auto px-4 sm:px-6 border-b border-gray-300 pb-3">
     //         <div className="flex items-center mb-6">
     //           <div className="flex items-center justify-center h-8 w-8 rounded-full bg-pink-100 text-pink-500 mr-3">
     //             <span className="text-sm font-medium">P</span>
     //           </div>
     ...
     //       <div className="max-w-md mx-auto px-4 sm:px-6 pt-3">
     //         <div className="flex items-center mb-6">
     //           <div className="flex items-center justify-center h-8 w-8 rounded-full bg-pink-100 text-pink-500 mr-3">
     //             <span className="text-sm font-medium">P</span>
     //           </div>
     ...
     //     {/* content - improved relationship details container */}
     ...
     //             <div
     //               key={message.id}
     //               className={`mb-4 ${message.isAi ? '' : 'flex justify-end'}`}
     //             >
     //               <div
